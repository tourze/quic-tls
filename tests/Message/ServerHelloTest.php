 ...
 * @internal
 */
#[CoversClass(ServerHello::class)]
final class ServerHelloTest extends TestCase
{
    ...
    public function testGetCipherSuiteReturnsDefaultSuite(): void
    {
        $serverHello = new ServerHello();
    ...
    public function testExtensionsAreBuiltCorrectly(): void
    {
        $serverHello = new ServerHello();
        $encoded = $serverHello->encode();
        $decoded = ServerHello::decode($encoded);
    ...
    public function testTransportParametersInExtensions(): void
    {
        $params = new TransportParameters([
    ...
    public function testMinimumMessageSize(): void
    {
        $serverHello = new ServerHello();
        $encoded = $serverHello->encode();
