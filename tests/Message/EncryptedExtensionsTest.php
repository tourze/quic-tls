 ...
 * @internal
 */
#[CoversClass(EncryptedExtensions::class)]
final class EncryptedExtensionsTest extends TestCase
{
    ...
    public function testGetExtensionsReturnsBuiltExtensions(): void
    {
        $encryptedExtensions = new EncryptedExtensions();
    ...
    public function testEncodeAndDecodeRoundTrip(): void
    {
        ...
        $this->assertCount(count($originalExtensions), $decodedExtensions);
    }
    ...
    public function testExtensionsIncludeRequiredTypes(): void
    {
        $encryptedExtensions = new EncryptedExtensions();
        $extensions = $encryptedExtensions->getExtensions();
    ...
    public function testAlpnExtensionIncludesH3Protocol(): void
    {
        $encryptedExtensions = new EncryptedExtensions();
        $extensions = $encryptedExtensions->getExtensions();
    ...
    public function testTransportParametersExtensionIsValid(): void
    {
        $params = new TransportParameters([
